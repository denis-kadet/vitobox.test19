<section class="section">
    <div class="block-8">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="block__title block-7__title">Отзывы</div>
                </div>
            </div>
        </div>
            ...
            <div class="block-8__slider-wrap">
                <ul class="block-8__slider-items">
                    <li class="block-8__slider-item">
                        <div class="block__text block-8__text">«Мой персональный набор витаминов VitoBox помог мне похудеть. Это не было основной целью. Я исключил из рациона сахар. Добавил легкие кардио тренировки три раза в неделю по 15 минут. И всё в совокупности с витаминами через
                            месяц дало заметный результат».</div>
                        <picture>
                            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/block-5-feed-1.webp" type="image/webp">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/block-5-feed-1.jpeg " alt="icon:app " class="block-8__img">
                        </picture>
                        <div class="block-8__text-name">Дмитрий Гиенко</div>
                        <div class="block__text">Арт-директор GQ</div>
                    </li>
                    <li class="block-8__slider-item">
