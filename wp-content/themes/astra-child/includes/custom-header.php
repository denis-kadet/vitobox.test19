...
add_action( 'after_setup_theme', function(){
    register_nav_menus( [
        'mobile_menu1' => 'Кастомное мобильное меню',
        'header_menu1' => 'Кастомное меню хедера',
        'footer_menu1' => 'Кастомное меню футера'

    ] );
} );
function menu_mobile_header(){
    wp_nav_menu([
        'theme_location' => 'mobile_menu1',
        'container' => 'nav',
...
function menu_top_header(){
    wp_nav_menu([
        ...
        'container' => 'nav',
        'container_class' => 'header__nav1',
        'menu_class' => 'header__nav1-items',
